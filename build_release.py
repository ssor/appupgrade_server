...
code = os.system("GOOS=linux GOARCH=amd64 go build -o ./release/upgrade_linux64 main.go")
if code > 0:
...
ignoredDirs = ["controller", "controllers_test", "libs", "models", "release", "tests", "api", "router", "data",
               "xsbupgradeFE"]
